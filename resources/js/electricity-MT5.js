...
function loadMT1Rates() {
  for (let key in mt_6) {
    document.getElementById(key).innerHTML = mt_6[key].toFixed(2); ///upto 2 decimal places
  }
}
...
function generateBill() {
  ...
  if (!isNaN(offpkunit) && !isNaN(pkunit) && !isNaN(kwhomfval)) {
    ...
    var finaloffpkcost = finaloffpkunit * mt_6["offpkrate"];
    var finalpkunit = pkunit * kwhomfval;
    var finalpkcost = finalpkunit * mt_6["pkrate"];
    ...
    if (!isNaN(xflosspercentage) && xflosspercentage > minXFLoss) {
      ...
      var finalxfoffpkcost = finalxfoffpkunit * mt_6["offpkrate"];
      var finalxfpkunit = finalpkunit * xflosspercentage * 0.01;
      var finalxfpkcost = finalxfpkunit * mt_6["pkrate"];
    ...
    var finalsrcost = finalsrunit * mt_6["srrate"];
    ...
    if (!isNaN(childunit)) {
      ...
      childunitsrcost = childunitsr * mt_6["srrate"];
    ...
    if (!isNaN(xflosspercentage) && xflosspercentage > minXFLoss) {
      ...
      var finalxfsrcost = finalxfsrunit * mt_6["srrate"];
