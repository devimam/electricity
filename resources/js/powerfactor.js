...
(function () {
  ...
  pfoffpeakelm.addEventListener("change", validatepfoffpeak);
  ...
  pfpeakelm.addEventListener("change", validatepfpeak);
  ...
  pfvarelm.addEventListener("change", validatepfvar);
