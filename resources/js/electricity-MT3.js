...
var demandCharge = 90; ///per kW for MT-3
var minSLoad = 0;
var minOMF = 1;
var minMaxDemand = 0;
var minOffPkUnit = 0;
...
function loadMT3Rates() {
  for (let key in mt_3) {
    document.getElementById(key).innerHTML = mt_3[key].toFixed(2); ///upto 2 decimal places
  }
}
...
function generateBill() {
  ...
  if (!isNaN(offpkunit) && !isNaN(pkunit) && !isNaN(kwhomfval)) {
    ...
    var finaloffpkcost = finaloffpkunit * mt_3["offpkrate"];
    var finalpkunit = pkunit * kwhomfval;
    var finalpkcost = finalpkunit * mt_3["pkrate"];
    ...
    if (!isNaN(xflosspercentage) && xflosspercentage > minXFLoss) {
      ...
      var finalxfoffpkcost = finalxfoffpkunit * mt_3["offpkrate"];
      var finalxfpkunit = finalpkunit * xflosspercentage * 0.01;
      var finalxfpkcost = finalxfpkunit * mt_3["pkrate"];
    ...
    var finalsrcost = finalsrunit * mt_3["srrate"];
    ...
    if (!isNaN(childunit)) {
      ...
      childunitsrcost = childunitsr * mt_3["srrate"];
    ...
    if (!isNaN(xflosspercentage) && xflosspercentage > minXFLoss) {
      ...
      var finalxfsrcost = finalxfsrunit * mt_3["srrate"];
